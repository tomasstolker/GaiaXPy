...
from gaiaxpy import generate, load_additional_systems, remove_additional_systems
...
def test_truncation():
    ...
    no_trunc = generate(c04_trunc_input, photometric_system=_PhotometricSystem.USER_GaiaC4Eps, truncation=False,
                        save_file=False)
    trunc = generate(c04_trunc_input, photometric_system=_PhotometricSystem.USER_GaiaC4Eps, truncation=True,
                     save_file=False)
