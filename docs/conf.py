# -*- coding: utf-8 -*-
#
# Configuration file for the Sphinx documentation of the GaiaXPy package.
...
# Hide whole path to the method as it is already known
...
man_pages = [
    (master_doc, 'GaiaXPy documentation', u'GaiaXPy Documentation',
     [author], 1)
]
